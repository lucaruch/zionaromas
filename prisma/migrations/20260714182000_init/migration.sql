...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('RECEBIDO', 'PAGO', 'SEPARACAO', 'ENVIADO', 'ENTREGUE', 'CANCELADO');
...
-- CreateIndex
CREATE UNIQUE INDEX "Favorite_productId_customerId_key" ON "Favorite"("productId", "customerId");
