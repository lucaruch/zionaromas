        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="rounded-lg bg-black p-8 text-white">
            ...
            <div className="mt-8 flex gap-3">
              ...
              <Link href="/cadastro"><Button variant="glass">Criar conta</Button></Link>
            </div>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            {shortcuts.map(({ href, label, icon: Icon }) => (
              <Link key={href} href={href} className="rounded-lg border border-black/10 p-7 transition hover:-translate-y-1 hover:border-gold hover:shadow-premium">
